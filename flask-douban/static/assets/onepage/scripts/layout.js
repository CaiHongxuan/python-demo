var Layout = function () {
    ...
    var handleScrolling = function () {
        $(".scroll").on("click", function(event) {
            ...
            console.log('scrolling', this.href.split("#")[1], $("#"+this.href.split("#")[1]).offset().top);
    ...
    var handleTwitter = function () {
        !function(d,s,id){
            var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="/static/assets/onepage/scripts/widgets.js";fjs.parentNode.insertBefore(js,fjs);}
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", "/static/assets/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", "/static/assets/onepage/img/logo/" + color + ".png");
        }
